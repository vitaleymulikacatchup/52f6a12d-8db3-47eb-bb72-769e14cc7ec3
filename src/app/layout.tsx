...
export const metadata: Metadata = {
  title: "F1 Teams Hub - Complete Formula 1 Teams Information",
  ...
  keywords: "Formula 1, F1 teams, racing, motorsport, statistics, drivers, team profiles",
  metadataBase: new URL("https://f1teamshub.com"),
  alternates: {
    canonical: "https://f1teamshub.com"
  },
  openGraph: {
    title: "F1 Teams Hub - Ultimate Formula 1 Teams Platform",
    description: "Comprehensive F1 teams information with real-time updates, statistics, and interactive features for Formula 1 enthusiasts.",
    url: "https://f1teamshub.com",
    siteName: "F1 Teams Hub",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763641728566-ei44125f.jpg",
      alt: "Formula 1 racing cars on track"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "F1 Teams Hub - Ultimate Formula 1 Teams Platform",
    description: "Comprehensive F1 teams information with real-time updates and interactive features.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763641728566-ei44125f.jpg"]
  },
  robots: {
    index: true,
    follow: true
